...
Public Class Nfe_ImprimirDanfeRetratoNFCe
    ...
    Private Font8_black As New Font("Times New Roman", 8, FontStyle.Bold)
    ...
    '----------------------------------------------------------
    Private V_PRODUTOS_Retrato As IList(Of ProdutoDanfe_RetratoNFCe)
    Public Property AddProdutosDanfe() As IList(Of ProdutoDanfe_RetratoNFCe)
        Get
            Return V_PRODUTOS_Retrato
        End Get
        Set(ByVal value As IList(Of ProdutoDanfe_RetratoNFCe))
            V_PRODUTOS_Retrato = value
        End Set
    End Property


    Private V_FATURA_Retrato As IList(Of FaturaDanfe_RetratoNFce)
    Public Property AddfaturaDanfe() As IList(Of FaturaDanfe_RetratoNFce)
        Get
            Return V_FATURA_Retrato
        End Get
        Set(ByVal value As IList(Of FaturaDanfe_RetratoNFce))
    ...
    Public Sub New()
        ...
        V_PRODUTOS_Retrato = New List(Of ProdutoDanfe_RetratoNFCe)()
        V_FATURA_Retrato = New List(Of FaturaDanfe_RetratoNFce)()
    End Sub
    ...
    Public Sub VisualizarImpressao()
        ...
        If I_Doutros_Retrato.nameprint <> "" Then
            Doc_VisualizarDanfe.PrinterSettings.PrinterName = I_Doutros_Retrato.nameprint
        End If
    ...
    Private Sub InserirCabecalho(ByVal Gra_Saida As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Try
            ...
            qrcode = qrencod.Encode(I_DDadosNfe_Retrato.QRcodevlr)


            Gra_Saida.Graphics.DrawImage(TryCast(qrcode, Image), 600, 60, 85, 85)
        ...
        Gra_Saida.Graphics.DrawString("DANFE NFC-e", Font12_B, Brushes.Black, 350, 23, New StringFormat)
        Gra_Saida.Graphics.DrawString("  Documento Auxiliar da Nota", FontArial6, Brushes.Black, 347, 43, New StringFormat)
        Gra_Saida.Graphics.DrawString("Fiscal de Consumidor Eletrônica", FontArial6, Brushes.Black, 347, 53, New StringFormat)
        Gra_Saida.Graphics.DrawString("0 - ENTRADA", FontArial8, Brushes.Black, 347, 68, New StringFormat)
        Gra_Saida.Graphics.DrawString("1 - SAÍDA", FontArial8, Brushes.Black, 347, 83, New StringFormat)
        Gra_Saida.Graphics.DrawString("NFC-e nº   " & Int32.Parse(I_DDadosNfe_Retrato.NUMERO_NFE).ToString("000,000,000"), FontArial8, Brushes.Black, 347, 98, New StringFormat)
        Gra_Saida.Graphics.DrawString("SÉRIE  " & Int32.Parse(I_DDadosNfe_Retrato.SERIE_NFE).ToString("000"), FontArial8, Brushes.Black, 347, 115, New StringFormat)
        ...
        ' Dados Nfe
        ''''''''''''''''''''''''''''''''''''''dir''bai''l''''sima
        Gra_Saida.Graphics.DrawRectangle(pen, 475, 20, 320, 129)
        ...
        ContaProdutos1 = 0
        For Each PDanfe As ProdutoDanfe_RetratoNFCe In V_PRODUTOS_Retrato
            ContaProd += 1
        ...
        Gra_Saida.Graphics.DrawString("Consulte pela Chave de Acesso em", Font8_black, Brushes.Black, 550, 20, New StringFormat)
        Gra_Saida.Graphics.DrawString("   http://nfce.fazenda.mg.gov.br/portalnfce", Font8_black, Brushes.Black, 520, 32, New StringFormat)
        Gra_Saida.Graphics.DrawString(NChave, FontArial8, Brushes.Black, 482, 45, New StringFormat)
    ...
    Private Sub Preencher_Dados_Danfe(ByVal Gra_Saida As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Gra_Saida.Graphics.DrawString("CONSUMIDOR", New Font("Times New Roman", 6, FontStyle.Regular), Brushes.Black, 8, 207, New StringFormat)
        ...
        Gra_Saida.Graphics.DrawLine(pen, 620, 272, 620, 299)
        ...
        Gra_Saida.Graphics.DrawString("INDICADOR IE DESTINATÁRIO", Font5_B, Brushes.Black, 622, 272, New StringFormat)
        Gra_Saida.Graphics.DrawString(V_DDestinatario_Retrato.IE_IND, FontArial7, Brushes.Black, 622, 286, New StringFormat)
        ...
        For Each PDanfe_fat As FaturaDanfe_RetratoNFce In V_FATURA_Retrato
...
Public Class ProdutoDanfe_RetratoNFCe
...
Public Class FaturaDanfe_RetratoNFce
